      ...
      <div class="flex justify-between h-16">
        <div class="flex items-center">
          <a href="/" class="flex items-center space-x-2">
            <span class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">EstateChain</span>
          </a>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p class="text-gray-400">Democratizing real estate investment through blockchain technology.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            <li><a href="https://discord.gg/realtokens" class="hover:text-white transition-colors">Discord</a></li>
            <li><a href="https://twitter.com/realtokens" class="hover:text-white transition-colors">Twitter</a></li>
          </ul>
        </div>
      </div>
